...
namespace DAL.Migrations
{
    ...
    [Migration("20200115185304_AddDiscountSupport")]
    partial class AddDiscountSupport
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Common.Model.BaseDiscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("BaseDiscount");
                });
            ...
            modelBuilder.Entity("Common.Model.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Price = 50m,
                            PublishDate = new DateTime(2020, 1, 15, 20, 53, 4, 331, DateTimeKind.Local).AddTicks(3236),
                            PublisherId = 1,
                            Title = "A Book",
                            AuthorId = 1,
            ...
            modelBuilder.Entity("Common.Model.Journal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 2,
                            Price = 40m,
                            PublishDate = new DateTime(2020, 1, 15, 20, 53, 4, 334, DateTimeKind.Local).AddTicks(2747),
                            PublisherId = 1,
                            Title = "journal",
                            Issn = "12345631",
                            IssueNum = 1
            ...
            modelBuilder.Entity("Common.Model.AuthorDiscount", b =>
                {
                    b.HasBaseType("Common.Model.BaseDiscount");
                    ...
                    b.HasDiscriminator().HasValue("AuthorDiscount");
                });

            modelBuilder.Entity("Common.Model.GenreDiscount", b =>
                {
                    b.HasBaseType("Common.Model.BaseDiscount");
            ...
            modelBuilder.Entity("Common.Model.PublishDateDiscount", b =>
                {
                    b.HasBaseType("Common.Model.BaseDiscount");
                    ...
                    b.HasDiscriminator().HasValue("PublishDateDiscount");
                });

            modelBuilder.Entity("Common.Model.PublisherDiscount", b =>
                {
                    b.HasBaseType("Common.Model.BaseDiscount");
                    ...
                    b.HasDiscriminator().HasValue("PublisherDiscount");
                });
